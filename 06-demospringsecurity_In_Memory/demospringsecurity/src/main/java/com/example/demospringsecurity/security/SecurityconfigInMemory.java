...
//              .cors(cors -> someCorsConfig we can set to allow only certain Type of request ike GET PUT and other blocked)
   ...
   We can create many types of password Encoder instance
  1.  a normal noOpsEncoder instance - passwords are compared in raw string format
